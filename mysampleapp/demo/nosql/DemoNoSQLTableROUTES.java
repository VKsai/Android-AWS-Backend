...
public class DemoNoSQLTableROUTES extends DemoNoSQLTableBase {
    ...
    public class DemoGetWithPartitionKey extends DemoNoSQLOperationBase {
        ...
        public boolean executeOperation() throws AmazonClientException {
            ...
            result = mapper.load(ROUTESDO.class, AWSMobileClient.defaultMobileClient().getIdentityManager().getCachedUserID());
    ...
    public void insertSampleData() throws AmazonClientException {
        ...
        firstItem.setCategory(
            DemoSampleDataGenerator.getRandomSampleString("category"));
        ...
        firstItem.setNumberTraveled(DemoSampleDataGenerator.getRandomSampleNumber());
        firstItem.setRouteId(
            DemoSampleDataGenerator.getRandomSampleString("routeId"));
        ...
        firstItem.setUsed(DemoSampleDataGenerator.getRandomSampleNumber());
        ...
        for (int count = 0; count < SAMPLE_DATA_ENTRIES_PER_INSERT-1; count++) {
            ...
            item.setCategory(DemoSampleDataGenerator.getRandomSampleString("category"));
            ...
            item.setNumberTraveled(DemoSampleDataGenerator.getRandomSampleNumber());
            ...
            item.setUsed(DemoSampleDataGenerator.getRandomSampleNumber());
